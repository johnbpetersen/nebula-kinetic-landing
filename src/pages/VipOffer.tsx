...
// Upgraded with branded perk images.
...
const PERKS = [
  {
    ...
    bgImage: "https://alluviance.s3.us-east-2.amazonaws.com/images/practicing.jpg", // <-- UPDATED
  },
  {
    icon: HelpCircle,
    title: "Priority Q&A",
    description: "VIP questions jump the line so you leave with clarity and next steps you can implement immediately.",
    bgImage: "https://alluviance.s3.us-east-2.amazonaws.com/images/hands-up.jpg", // <-- UPDATED
  },
  {
    icon: PlayCircle,
    title: "Full Masterclass Replay",
    description: "Can’t attend live? You’ll receive the full session recording right in your inbox to watch anytime.",
    bgImage: "https://alluviance.s3.us-east-2.amazonaws.com/images/replay.jpg", // <-- UPDATED
  },
  {
    icon: Users,
    ...
    bgImage: "https://alluviance.s3.us-east-2.amazonaws.com/images/community.jpg", // <-- UPDATED
  },
];
...
export default function VipOffer() {
  ...
  const handleBuy = () => {
    ...
    if (!paymentLinkUrl || paymentLinkUrl === "#") {
      alert("VIP checkout isn’t configured yet. Please set VITE_STRIPE_PAYMENT_LINK_URL in your .env.local.");
      return;
    }
      ...
      <main className="section-container py-12 md:py-20">
        <div className="mx-auto max-w-4xl space-y-12 md:space-y-16">
          ...
          >
            <div>
              <h1 className="text-2xl md:text-3xl font-display font-bold leading-tight text-center">
                Smart move{name ? `, ${name}` : ""}! We've locked in your seat for the Beyond Tactics Masterclass.
              </h1>
              <p className="mt-4 text-base text-gray-300">
                We’ve sent a confirmation and calendar invite to
                {email ? <strong className="text-white"> {email}</strong> : " your email"} for the{" "}
          ...
          <section className="text-center" aria-labelledby="vip-offer-title">
            ...
            >
              Upgrade to our VIP package for just $29 and stay after the masterclass for a <strong>30-minute immersive inner game experience</strong> with Alex to jumpstart your journey.
            </motion.p>
          </section>
            ...
            <div className="space-y-4 max-w-2xl mx-auto">
              <details className="glass-card p-5 cursor-pointer group">
                ...
                <p className="mt-3 text-gray-300">
                  No—VIP includes the full replay so you won’t miss a thing. You can watch it anytime, anywhere.
                </p>
              </details>
              <details className="glass-card p-5 cursor-pointer group">
                <summary className="text-lg font-semibold flex justify-between items-center">
                ...
                <p className="mt-3 text-gray-300">
                  You’ll still get massive value from hearing the live coaching of your peers and can submit your own questions via the priority Q&A.
                </p>
              </details>
            </div>
          </section>
